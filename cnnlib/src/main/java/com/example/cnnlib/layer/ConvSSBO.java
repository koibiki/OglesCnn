...
public class ConvSSBO extends Layer {
    ...
    public ConvSSBO(Context context, Layer preLayer, int kAmount, int k_w, int k_h, int pad, int stride_w, int stride_h, NonLinear.Type type, String kennelFilePath) {
