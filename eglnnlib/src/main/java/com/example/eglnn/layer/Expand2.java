 ...
 *
 * */
public class Expand2 extends Layer {
    ...
    public Expand2(Context context, Layer preLayer, int kAmount, ActiveType type, String kennel1FilePath, String kennel2FilePath) {
    ...
    private String createShaderSource(int startZ, int xSize, int zSize) {
        String shaderFile = "expand2.comp";
