...
//        mCnnNetwork.initialize();
    ...
    private void buildNet() {
        ...
        Layer conv1 = new ConvolutionLayer(this, in, 64, new int[]{3, 3, 3}, 1, new int[]{1, 1}, NonLinearLayer.NonLinearType.RELU, "");
        mCnnNetwork.addLayer(conv1);

        Layer pool1 = new PoolingLayer(this, conv1, new int[]{2, 2}, new int[]{2, 2});
        mCnnNetwork.addLayer(pool1);

        Layer conv2 = new ConvolutionLayer(this, pool1, 256, new int[]{3, 3, 64}, 1, new int[]{1, 1}, NonLinearLayer.NonLinearType.RELU, "");
        mCnnNetwork.addLayer(conv2);

        Layer pool2 = new PoolingLayer(this, conv2, new int[]{2, 2}, new int[]{2, 2});
        mCnnNetwork.addLayer(pool2);

        Layer conv3 = new ConvolutionLayer(this, pool2, 256, new int[]{3, 3, 256}, 1, new int[]{1, 1}, NonLinearLayer.NonLinearType.RELU, "");
        ...
        Layer softmaxLayer = new SoftMaxLayer(this, full3, 20);
        mCnnNetwork.addLayer(softmaxLayer);
